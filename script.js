...
function renderPortfolio() {
  ...
  projects.forEach(proj => {
    // If link is empty or falsy, do NOT show tech stack bars & labels
    const techStackHTML = proj.link ? createTechStackHTML(proj.techStack) : "";

    // Show button only if there is a link
